        ...
        if (this.isEnabled()) {
            switch (event.getType()) {
                case PRE:
                    ...
                    break;
                case POST:
                    // Rise Sprint (Watchdog Prediction): while KillAura is server-side blocking,
                    // keep sprint held so the client never drops it mid-block.
                    this.wasSprinting = mc.thePlayer.isSprinting() || KillAura.blocking;
            }
        }
    }
