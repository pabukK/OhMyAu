...
public class ModuleComponent implements Component {
    ...
    /** True when this module was actually drawn inside the category's visible scroll window last frame. */
    ...
    public void mouseDown(int x, int y, int button) {
        // Modules outside the visible scroll window are not drawn and must not
        // receive clicks; their stored offsets are stale and would overlap the
        // rows that are actually visible, causing phantom toggles.
